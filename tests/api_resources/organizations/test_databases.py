...
class TestDatabases:
    ...
    def test_method_create(self, client: Subhosting) -> None:
        database = client.organizations.databases.create(
    ...
    def test_raw_response_create(self, client: Subhosting) -> None:
        response = client.organizations.databases.with_raw_response.create(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_create(self, client: Subhosting) -> None:
        with client.organizations.databases.with_streaming_response.create(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_create(self, client: Subhosting) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            client.organizations.databases.with_raw_response.create(
                "",
            )

    @parametrize
    def test_method_list(self, client: Subhosting) -> None:
        database = client.organizations.databases.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_list(self, client: Subhosting) -> None:
        response = client.organizations.databases.with_raw_response.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_list(self, client: Subhosting) -> None:
        with client.organizations.databases.with_streaming_response.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Subhosting) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            client.organizations.databases.with_raw_response.list(
                "",
            )
...
class TestAsyncDatabases:
    ...
    async def test_method_create(self, async_client: AsyncSubhosting) -> None:
        database = await async_client.organizations.databases.create(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(KvDatabase, database, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncSubhosting) -> None:
        response = await async_client.organizations.databases.with_raw_response.create(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncSubhosting) -> None:
        async with async_client.organizations.databases.with_streaming_response.create(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_create(self, async_client: AsyncSubhosting) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            await async_client.organizations.databases.with_raw_response.create(
                "",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncSubhosting) -> None:
        database = await async_client.organizations.databases.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(DatabaseListResponse, database, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSubhosting) -> None:
        response = await async_client.organizations.databases.with_raw_response.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncSubhosting) -> None:
        async with async_client.organizations.databases.with_streaming_response.list(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncSubhosting) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            await async_client.organizations.databases.with_raw_response.list(
                "",
            )
